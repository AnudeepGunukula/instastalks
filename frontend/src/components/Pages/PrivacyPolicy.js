...
import classes from "./PrivacyPolicy.module.css"; // Import the CSS file
...
function PrivacyPolicy() {
  return (
    <div className={classes["privacy-container"]}>
      ...
      <p>
        Instastalks ("us", "we", or "our") operates the Instastalks website (the
      ...
      <h2>Information Collection And Uses</h2>
      <p>
      ...
      <p>
        ...
        include, but is not limited to: Cookies and Usage Data
      </p>
      <h4>Usage Data</h4>
      <p>
      ...
      <p>
        Examples of Cookies we use: <br></br>* Session Cookies.&nbsp;We use
        Session Cookies to operate our Service. <br></br>* Preference
        Cookies.&nbsp;We use Preference Cookies to remember your preferences and
        various settings. <br></br>* Security Cookies.&nbsp;We use Security
        Cookies for security purposes.{" "}
      </p>
      <h2>Use of Data</h2>
      <p>
        Instastalks uses the collected data for various purposes: <br></br>* To
        provide and maintain the Service <br></br>* To notify you about changes
        to our Service <br></br>* To allow you to participate in interactive
        features of our Service when you choose to do so <br></br>* To provide
        customer care and support <br></br>* To provide analysis or valuable
        information so that we can improve the Service <br></br>* To monitor the
        usage of the Service <br></br>* To detect, prevent and address technical
        issues{" "}
      </p>
      ...
      <p>
        If you are located outside Russian Federation and choose to provide
        information to us, please note that we transfer the data, including
        Personal Data, to Russian Federation and process it there.
      </p>
      <p>
      ...
      <p>
        Instastalks will take all steps reasonably necessary to ensure that your
      ...
      <p>
        Instastalks may disclose your Personal Data in the good faith belief
        that such action is necessary to: <br></br>* To comply with a legal
        obligation <br></br>* To protect and defend the rights or property of
        Instastalks <br></br>* To prevent or investigate possible wrongdoing in
        connection with the Service <br></br>* To protect the personal safety of
        users of the Service or the public <br></br>* To protect against legal
        liability{" "}
      </p>
